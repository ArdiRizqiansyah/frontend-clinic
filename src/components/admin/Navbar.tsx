...
function Navbar()
{
    ...
    const handlerProfileClick = () => setIsProfileMenu(!isProfileMenu);

    const navigate = useNavigate();

    // handle logout
    const handlerLogout = async () => {
      // set axiosm header with type authorization + bearer token
    ...
    return (
      <header className="z-10 py-4 bg-white shadow-md">
        <div className="container flex items-center justify-between md:justify-end h-full px-6 mx-auto text-purple-600">
          <button
          ...
          <ul className="flex items-center flex-shrink-0 space-x-6">
            ...
            <li className="relative">
              <button
                ...
                className="flex gap-3 items-center align-middle rounded-full focus:shadow-outline-purple focus:outline-none"
                aria-label="Account"
                aria-haspopup="true"
              >
              ...
              <template
                className={isProfileMenu ? "block" : "hidden"}
              >
                <ul
