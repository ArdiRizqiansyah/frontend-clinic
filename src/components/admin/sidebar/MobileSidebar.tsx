...
function MobileSidebar(){
    ...
    return (
      <aside
        // className={"fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-white md:hidden "}
        // buatkan classname sama seperti diatas tapi buat animasi jika sidebar di buka atau di tutup menggunakan kelas dari tailwind atau daisy ui
        className={
          "fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-white md:hidden " +
          (!isSidebarOpen
            ? "translate-x-0 ease-in duration-300"
            : "-translate-x-64 ease-out duration-300")
        }
      >
